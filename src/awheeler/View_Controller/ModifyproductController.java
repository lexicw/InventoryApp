...
import static awheeler.View_Controller.MainController.productModifyIndex;
...
public class ModifyproductController implements Initializable {
    ...
    void saveBtn(ActionEvent event) throws IOException {
        ...
        alert.setTitle("Product Modified");
        alert.setHeaderText("Product '" + productName + "' has been modified succesfully." );
        alert.showAndWait();
          }
        } catch (NumberFormatException e) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ProductInvTxt.setText(Integer.toString(product.getProductInStock()));
        ProductPriceTxt.setText(Double.toString(product.getProductPrice()));
        ProductMinTxt.setText(Integer.toString(product.getProductMin()));
        ProductMaxTxt.setText(Integer.toString(product.getProductMax()));
